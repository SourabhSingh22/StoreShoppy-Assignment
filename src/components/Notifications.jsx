...
const Notifications = ({ open }) => {
  return (
    <div
      className={`fixed md:static top-0 left-0 h-full border-l border-gray-200 bg-white transition-all duration-300 z-50 ${open ? "w-52" : "w-0 overflow-hidden bg-gray-100"}`}
    >
      {/* Header */}
