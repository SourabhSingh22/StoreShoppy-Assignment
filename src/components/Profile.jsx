...
import { MdDashboard, MdShoppingCart, MdWork, MdSchool, MdPerson, MdFolder, MdGroups, MdAccountCircle, MdBusiness, MdArticle } from "react-icons/md";
...
const Profile = ({openMenu}) => {
    ...
    return (
        <aside className={`fixed md:static top-0 left-0 h-full bg-white transition-all duration-300 z-50 ${openMenu ? "w-52" : "w-0 overflow-hidden bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200"}`}>
            ...
            <div>
                ...
                <div className="px-6 mb-2">
                    ...
                    <ul className="space-y-1 text-gray-700">
                        <li className="flex items-center gap-3 p-2 rounded-lg cursor-pointer hover:bg-gray-100 text-lg" onClick={showItems}>
                            <MdPerson className="text-lg" /> User Profile
                        </li>

                        {
                            showUserProfileItems && <div className={`
            ...
            <div className="px-6 py-6 flex items-center gap-2 justify-center">
                ...
                <p className="text-blue-500 text-lg">snow<span className="bg-gradient-to-r from-gray-300 to-gray-600 bg-clip-text text-transparent">ui</span></p>
            </div>
        </aside>
    );
}
